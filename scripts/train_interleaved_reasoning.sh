...
# Interleaved Reasoning Training Script
# Checkpoints saved to: ckpt/interleaved/<run_name>/
...
output_path=${output_path:-"./ckpt/interleaved/${run_name}/output"}
ckpt_path=${ckpt_path:-"./ckpt/interleaved/${run_name}"}
