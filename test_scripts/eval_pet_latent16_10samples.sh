#!/bin/bash
# Evaluation script for PET Latent16 (256x256 output) - 10 samples
...
export THINKMORPH_SAVE_DIR="/weka/oe-training-default/jieyuz2/improve_segments/visual_cot/ThinkMorph_training/results/pet_latent16/run_8gpu/0010000_10samples"

echo "=========================================="
echo "Evaluating PET Latent16 (256x256)"
echo "Model: ${THINKMORPH_MODEL_PATH}"
echo "Resolution: ${THINKMORPH_IMAGE_RESOLUTION}"
echo "Save Dir: ${THINKMORPH_SAVE_DIR}"
echo "=========================================="

python run.py --data AI2ThorPerspective_NoArrow_10 --model thinkmorph_pet --mode all --work-dir outputs_eval_latent16 --verbose
