#!/bin/bash
# Evaluate PET Latent32 on FULL dataset (800 samples)
# Checkpoint: ckpt/pet_latent32/run_8gpu/0010000_full
...
export THINKMORPH_SAVE_DIR="/weka/oe-training-default/jieyuz2/improve_segments/visual_cot/ThinkMorph_training/results/pet_latent32/run_8gpu/0010000_full_eval"

echo "=========================================="
echo "PET Latent32 - FULL Evaluation"
echo "=========================================="
...
python run.py \
    ...
    --mode all \
    --work-dir outputs_eval_latent32_full \
    --verbose
