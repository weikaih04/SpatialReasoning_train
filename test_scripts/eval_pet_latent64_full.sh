#!/bin/bash
# Evaluate PET Latent64 on FULL dataset (800 samples)
# Checkpoint: ckpt/pet_latent64/run_8gpu/0010000_full
...
export THINKMORPH_SAVE_DIR="/weka/oe-training-default/jieyuz2/improve_segments/visual_cot/ThinkMorph_training/results/pet_latent64/run_8gpu/0010000_full_eval"

echo "=========================================="
echo "PET Latent64 - FULL Evaluation"
echo "=========================================="
...
python run.py \
    ...
    --mode all \
    --work-dir outputs_eval_latent64_full \
    --verbose
