#!/bin/bash
# Evaluate PET No-Thought Baseline (text-only, no image generation)
# Checkpoint: ckpt/pet_no_thought/run_8gpu/0004000_full
# Dataset: AI2ThorPerspective_NoArrow_10 (10 samples)
...
export THINKMORPH_SAVE_DIR="/weka/oe-training-default/jieyuz2/improve_segments/visual_cot/ThinkMorph_training/results/pet_no_thought/run_8gpu/0004000_10samples"

echo "=========================================="
echo "PET No-Thought Baseline Evaluation"
echo "=========================================="
echo "Model: ${THINKMORPH_MODEL_PATH}"
echo "Save Dir: ${THINKMORPH_SAVE_DIR}"
echo "Dataset: AI2ThorPerspective_NoArrow_10"
echo "Mode: Text-only (no image generation)"
echo "=========================================="

python run.py \
    --data AI2ThorPerspective_NoArrow_10 \
    --model thinkmorph_pet_no_thought \
    --mode all \
    --work-dir outputs_eval_no_thought \
    --verbose
