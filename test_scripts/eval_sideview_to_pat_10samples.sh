#!/bin/bash
# Evaluate Sideview-to-PAT on Path Tracing (10 samples)
# Checkpoint: ckpt/sideview_to_pat/run_8gpu/0010000_full
...
export THINKMORPH_MODEL_PATH="/weka/oe-training-default/jieyuz2/improve_segments/visual_cot/ThinkMorph_training/ckpt/sideview_to_pat/run_8gpu/0010000_full"
export THINKMORPH_IMAGE_RESOLUTION=1024
export THINKMORPH_SAVE_DIR="/weka/oe-training-default/jieyuz2/improve_segments/visual_cot/ThinkMorph_training/results/sideview_to_pat/run_8gpu/0010000_10samples"

echo "=========================================="
echo "Sideview-to-PAT Path Tracing Evaluation"
echo "=========================================="
...
python run.py \
    ...
    --mode all \
    --work-dir outputs_eval_sideview_to_pat \
    --verbose
